...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xddahk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xddahk.containers.anotherwebservice.com/
...
```
git clone git@github.com:Bacon1053/container-xddahk.git
cd container-xddahk
```
...
```
docker attach container-xddahk
```
